...
class PriorityQueue {
    ...
    enqueue2(priority) {
        // creating object from queue element
        var qElement = new QElement2(priority);
        var contain = false;
...
priorityQueue.enqueue("Sumit", 4);
priorityQueue.enqueue("Gourav", 8);
priorityQueue.enqueue("Piyush", 6);
priorityQueue.enqueue("Sunny", 12);
